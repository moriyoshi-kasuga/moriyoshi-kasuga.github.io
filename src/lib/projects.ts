...
function compareProjects(a: CollectionEntry<"projects">, b: CollectionEntry<"projects">): number {
...
export async function getFeaturedProjects(limit: number): Promise<CollectionEntry<"projects">[]> {
