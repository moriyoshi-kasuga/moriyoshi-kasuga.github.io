...
export type LinkVariant = "primary" | "success" | "warning" | "danger";
...
] as const satisfies readonly { href: string; label: string; icon: string; variant: LinkVariant; headingClass: string }[];
