  ...
  return (
    <div className='min-h-all flex w-full flex-col items-center bg-primary-300 py-10 text-zinc-100'>
      <div className='flex flex-col items-center'>
        <h1 className='font-mono-jp text-7xl font-semibold text-white'>MoriLab</h1>
        ...
        <div className='container mt-10 flex max-w-[1200px] flex-wrap'>
          <h2 className='mb-10 w-full text-center font-mono-jp text-5xl font-medium'>
            Projects
          </h2>
                ...
                >
                  <div className='mx-4 my-2 flex flex-col items-center justify-center rounded-2xl'>
                    <Image
                      ...
                      height={160}
                    />
                    <p className="relative text-nowrap font-mono-jp text-lg font-medium transition-all before:absolute before:-left-3 after:absolute group-hover:scale-110 group-hover:before:content-['>'] group-hover:after:content-['<'] md:text-lg">
                      {project.title}
                    </p>
                  </div>
                </Link>
      ...
      <div className='mt-8 flex w-2/3 flex-col items-center justify-center'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-x-3 md:flex-nowrap'>
          ...
          />
          <div>
            <p className='max-w-xl font-sans-jp font-medium text-white sm:text-lg md:text-xl'>
